...
The production version of this application can be viewed at (https://www.pekerow.site) and differs from this repository by using Postgresql as the database engine in place of SQLite, and is secured by an SSL certificate, enabling the https protocol. The development version of _Item Catalog_ articulated below is for test use only on a local machine running a virtual Ubuntu 22.04 linux box. To get started please proceed as follows:
