...
The production version of this application can be viewed at (https://www.pekerow.site) and differs from this repository in two ways. Postgresql is used as the database engine is used in place of SQLite, and the application is secured by an SSL certificate, thereby enabling the https protocol. The development version of _Item Catalog_ articulated below is for test use only on a local machine running a virtual Ubuntu 22.04 linux box. To get started please proceed as follows:
